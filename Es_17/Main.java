...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println(myBankBalanceEuro);//Add the questionable funds to your bank balance and print it out!
    }
     ...
     *    2f: The number of kilometers from any 2 places in the world->short se intero altrimenti double
     */
    ...
    public static void exercise3() {
        ...
        System.out.println(myDate.getDayOfWeek()+","+myDate.getDayOfMonth()+","+myDate.getDayOfYear());
        System.out.println(myDate.getMonth());
        System.out.println(myDate.getMonthValue());
        LocalDate seconDate = LocalDate.of(2021,06,27);
        if (myDate.isBefore(seconDate)){
            System.out.println("Sono in tempo");
        } else {System.out.println("Troppo tardi");}
